<%-- 
    Document   : SignUpCustomerFailed
    Created on : Dec 16, 2020, 12:20:17 AM
    Author     : asus
--%>
        ...
        <div class="login-clean">
            <form action='DaftarCustomer' method="post">
                ...
                <div class="alert alert-danger alert-dismissible fade show">
                    <strong>Error!</strong> Anda sudah pernah terdaftar <a href="redirect.jsp" class="alert-link">Lupa Password?</a>
