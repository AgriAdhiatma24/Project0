<%-- 
    Document   : SignUpPenjual
    Created on : Dec 16, 2020, 5:58:43 PM
    Author     : antbagoes
--%>
    ...
    <body>
        <div class="login-clean">
            <form action='DaftarPenjual' method="post" style="margin-bottom: -25px;margin-top: 16px;">
                ...
                <div class="form-group"><input class="form-control" type="text" placeholder="Nama" name="nama"></div><input class="form-control" type="tel" placeholder="No. Telepon" name="notelpon" style="margin-bottom: 15px;"><input class="form-control" type="text" placeholder="Nama Toko"
                                                                                                                                                                                                        name="namatoko" style="margin-top: 16px;margin-bottom: 16px;"><textarea class="form-control" placeholder="Alamat Toko" name="alamattoko"></textarea>
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit" style="margin-bottom: -31px;">Daftar</button></div>
                <a class="d-block float-left" href="SignUpCustomer.jsp" style="padding: 0px;padding-top: 0px;margin-top: 30px;">Daftar Sebagai Customer</a>
            </form>
        </div>
