<%-- 
    Document   : HelpPage
    Created on : Dec 17, 2020, 4:33:37 AM
    Author     : asus
--%>
...
<html style="width: 100%;height: 100%;">
    ...
    <body style="width: 100%;height: 100%;">
                ...
                <div class="container"><a class="navbar-brand" href="#"><img src="assets/img/UKM%20GWE2.png?h=bd322fd5758fd3eacf4ebe3863a8f937" width="100px"></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div
                        ...
                        <ul class="nav navbar-nav ml-auto" style="margin: 0px;margin-left: 109px;">
                            <li class="nav-item" role="presentation"><a class="nav-link" href="#">Keranjang</a></li>
        ...
        <div class="container" style="width: 100%;max-width: 100%;height: 90%;padding: 15px;">
            <form method="post" style="margin: auto;margin-top: auto;margin-right: auto;margin-bottom: auto;margin-left: auto;width: 80%;">
                <h1 class="text-center" style="margin-bottom: 20px;">Halaman Bantuan</h1>
                <div class="form-group"><textarea class="form-control" name="deskripsi" placeholder="Apa yang anda butuhkan?"></textarea></div>
                <div class="form-group"><a class="btn btn-primary btn-block" type="submit" href="#" style="background-color: rgb(67,67,67);">Submit</a></div>
            </form>
        </div>
