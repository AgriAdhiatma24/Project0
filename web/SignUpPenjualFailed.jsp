<%-- 
    Document   : SignUpPenjualFailed
    Created on : Dec 16, 2020, 12:53:50 AM
    Author     : asus
--%>
        ...
        <div class="login-clean">
            <form action='DaftarPenjual' method="post" style="margin-bottom: -25px;margin-top: 16px;">
                ...
                <div class="alert alert-danger alert-dismissible fade show">
                    <strong>Error!</strong> Anda sudah pernah terdaftar <a href="redirect" class="alert-link">Lupa Password?</a>
